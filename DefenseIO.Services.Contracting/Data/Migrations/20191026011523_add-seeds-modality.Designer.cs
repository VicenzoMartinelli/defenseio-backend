...
namespace DefenseIO.Services.Contracting.Data.Migrations
{
    ...
    [Migration("20191026011523_add-seeds-modality")]
    partial class addseedsmodality
    {
            ...
            modelBuilder.Entity("DefenseIO.Domain.Domains.Contracting.Entities.Modality", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("4b8b3ed4-ccb5-4322-8cd6-350961f62351"),
                            Description = "Segurança pessoal",
                            Key = "Personal"
                        },
                        new
                        {
                            Id = new Guid("149999ef-e145-4df4-a712-8820674a3184"),
                            Description = "Escolta armada",
                            Key = "ArmedEscort"
                        },
                        new
                        {
                            Id = new Guid("3a515d77-5947-4884-bc8a-16e6f2674c82"),
                            Description = "Transporte de valores",
                            Key = "ValuesTransportation"
                        },
                        new
                        {
                            Id = new Guid("03bcf91a-896b-4bdf-a819-e9db394780e0"),
