...
{
  public class UpdateAttendedModalityCommand : Command<AttendedModalityViewModel>
  {
    ...
    public UpdateAttendedModalityCommand ByProviderUserIdAndAttendedModalityId(Guid providerUserId, Guid attendedModalityId)
    {
      ProviderUserId = providerUserId;
      Id = attendedModalityId;
